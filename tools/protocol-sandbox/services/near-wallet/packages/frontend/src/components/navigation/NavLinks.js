...
const NavLinks = () => (
    <Container className='nav-links'>
        ...
        <a href='tools/protocol-sandbox/services/near-wallet/packages/frontend/src/components/navigation/NavLinks' target='_blank' rel='noopener noreferrer' onClick={() => Mixpanel.track('Click Help button on nav')}>
            <HelpIcon/>
