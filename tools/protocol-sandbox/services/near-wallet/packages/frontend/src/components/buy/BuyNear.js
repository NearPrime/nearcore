    ...
    return (
        <StyledContainer className='small-centered'>
            ...
            <div className='exchanges'>
                <a href='tools/protocol-sandbox/services/near-wallet/packages/frontend/src/components/buy/BuyNear' target='_blank' rel='noreferrer'>
            ...
            <div className='see-more'>
                <Translate id='buyNear.seeMore' /> <a href='tools/protocol-sandbox/services/near-wallet/packages/frontend/src/components/buy/BuyNear' target='_blank' rel='noreferrer' className='link'><Translate id='buyNear.coinMarketCap' /></a>
            </div>
